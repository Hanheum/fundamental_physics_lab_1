...
df = pd.read_csv('./damped_freq_data.csv')
...
alpha=0.003305673211926458
beta=-0.10024020733006606
gamma=0.8189859508178624
RMSE=0.013163720210571316
R_2=0.9584393202683829

w2_point = -beta/(2*alpha)
w_natural = w2_point**0.5
